...
export default function FormTalbar() {
    const { tomState, yurunkhiiMedeelelAvya, zuragAvya } = React.useContext(TogloltContext)
    return (
            ...
            <div className='flex flex-row w-full p-2'>
                <div className='bg-white p-1 rounded'>
                    <Image
                        ...
                        width={300}
                        height={280}
                        // src={!isNullOrUndefined(tomState.zurag) ? tomState.zurag : 'error'}
                        src={!isNullOrUndefined(tomState.zurag) && tomState.zurag != '' && tomState.zurag != 'photo_6437c1d2c1650dabadd6d822.jpg' ? tomState.zurag : 'error'}
                    ...
                    />
                    <button className='bg-sky-700 w-full flex justify-center items-center rounded-[4px] py-1 text-white hover:shadow-lg shadow-sky-700' onClick={() => zuragAvya()}>
                        <span>
                            Зураг оруулах
                        </span>
                    </button>
